...
library(readxl)
# Selecting template
pres1 <- read_pptx("C:/Users/Qilincaizi/Desktop/BU_MSSP/Fall_2018/MA615_Data_Sci_in_R/11.12_ppt_slides/class_example.pptx")
# get the layout
...
pres1 %<>% add_slide(layout = "Title and Content", master = master ) %>% 
  ...
  ph_with_img( src = "C:/Users/Qilincaizi/Desktop/BU_MSSP/Fall_2018/MA615_Data_Sci_in_R/11.12_ppt_slides/Stock_Certificate.jpg")
```
...
pres1 %<>% add_slide(layout = "Title and Content", master = master ) %>% 
  ...
  ph_with_img_at( src = "C:/Users/Qilincaizi/Desktop/BU_MSSP/Fall_2018/MA615_Data_Sci_in_R/11.12_ppt_slides/bear_market.jpg", width = 4.5, height = 2.5, left = 4.5, top = 4.5)
```

# Slide 5 - Stock Market Indexes
```{r }
top_30 <- read_excel("C:/Users/Qilincaizi/Desktop/BU_MSSP/Fall_2018/MA615_Data_Sci_in_R/11.12_ppt_slides/top_30.xlsx")
top_5 <- top_30[1:5,]
pres1 %<>% add_slide(layout="Title and Content",master=master) %>%
...
```{r }
DJI85 <- read_excel("C:/Users/Qilincaizi/Desktop/BU_MSSP/Fall_2018/MA615_Data_Sci_in_R/11.12_ppt_slides/DJI85.xlsx")
options(scipen = 999)
